...
export default function App() {
  ...
  return (
    <div>
      ...
      <div className="card">
        <button onClick={() => setUserId(userId => userId + "x")}>fetch other user</button>
        <div>
      ...
      <div className="card">
        <AsyncContainer childProps fallback={() => <Loading/>} renderError={(err) => <span>ERROR {err}</span>}>
...
export function AsyncContainer<TChildProps = void>(props: IContainerProps<TChildProps>): React.ReactElement | null {
...
export async function AsyncComponent(props: IProps): Promise<React.ReactElement> {
